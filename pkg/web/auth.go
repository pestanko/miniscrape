...
func HandleAuthLogout(_ *pkg.Service, w http.ResponseWriter, req *http.Request) {
...
func HandleAuthLogin(service *pkg.Service, w http.ResponseWriter, req *http.Request) {
...
func HandleSessionStatus(_ *pkg.Service, w http.ResponseWriter, req *http.Request) {
